...
bool download_piece(int client_socket, int piece_index, int piece_length, const std::string& expected_hash, const std::string& download_filename = "", char* file_buffer = nullptr, int64_t buffer_offset = 0);
