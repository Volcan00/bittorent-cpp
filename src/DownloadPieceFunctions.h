...
void complete_piece_download(const std::string& ip, int port, const std::string& info_hash, const std::string& peer_id, int piece_index, int piece_length, 
                       const std::string& download_filename, bool download = true);
